...
const product = {
  ...
  code: "GS-ZP-1200",
  summary:
    "Top-tier medium frequency induction heating machine for large-scale production and demanding industrial heating scenarios.",
} as const;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `/products/${product.category.slug}/1200kw-medium-frequency-induction-heating-machine.html`,
  },
};
            ...
            <div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-10 md:p-12 text-white">
                <Prose className="text-white [&_a]:text-blue-300 [&_a]:decoration-blue-300/40">
                  ...
                  <p>
                    For detailed specifications, please contact us with your required output power and duty cycle.
                  </p>
                  <h2>Applications</h2>
                  <ul>
                    <li>Large-scale forging heating</li>
                    <li>High power induction heating lines</li>
                    <li>Industrial heat treatment</li>
                  </ul>
                  <h2>Video</h2>
                </Prose>
